  ...
  return (
    <>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-12">
              <div>
                ...
                <p className="text-gray-500 mt-2 font-light">
                  Curated masterpieces from our finest craftsmen
                </p>
              </div>
              <Link
                to="/shop"
                className="hidden sm:flex items-center gap-2 text-sm font-semibold text-brand-gold hover:text-brand-gold-dark tracking-wide uppercase mt-4 sm:mt-0 group"
              >
                View All Collection
      ...
      <section className="bg-brand-cream py-20 sm:py-24">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-12">
          <div className="bg-white rounded-sm border border-gray-100 shadow-[0_8px_40px_rgba(0,0,0,0.04)] overflow-hidden">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-[400px] bg-brand-dark p-10 sm:p-12 flex flex-col justify-center text-white">
