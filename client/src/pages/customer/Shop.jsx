      ...
      <div className="shop-page">
        ...
        <div className="shop-hero">
          <div style={{position:'relative',zIndex:1,textAlign:'center'}}>
            <nav style={{display:'flex',alignItems:'center',justifyContent:'center',gap:'8px',marginBottom:'20px',fontSize:'11px',color:'#6a5848',letterSpacing:'0.08em'}}>
              <Link to="/" style={{color:'#6a5848',textDecoration:'none',transition:'color 0.2s'}} onMouseOver={e=>e.currentTarget.style.color='#C5A059'} onMouseOut={e=>e.currentTarget.style.color='#6a5848'}>Home</Link>
              <ChevronRight size={10} style={{color:'#4a3828'}} />
              <span style={{color:'#C5A059',fontWeight:'500'}}>Shop</span>
            </nav>
            <h1 className="ch" style={{fontSize:'clamp(36px,5vw,60px)',color:'#f5ede0',fontWeight:'300',lineHeight:'1.1',marginBottom:'14px'}}>
              {title}
            </h1>
            <div style={{height:'1px',background:'linear-gradient(90deg,transparent,#C5A059,transparent)',width:'80px',margin:'0 auto 14px'}} />
            <p style={{color:'#8a7060',fontSize:'13px',fontWeight:'300',letterSpacing:'0.05em'}}>
              {pagination.total ? `${pagination.total} exquisite pieces` : 'Discover our collection'}
            </p>
          </div>
        </div>
