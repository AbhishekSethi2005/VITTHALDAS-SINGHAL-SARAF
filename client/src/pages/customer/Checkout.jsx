            ...
            <div style={{ minWidth: 0 }}>
              ...
              {step === 1 && (
                <div className="fade-up">
                  ...
                  {/* Items */}
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '28px', borderRadius: '14px' }}>
                    {items.map((item) => (
                      <div key={item._id} style={{ display: 'flex', alignItems: 'center', gap: '14px', background: 'white', border: '1px solid #ede0d0', padding: '14px', borderRadius: '8px' }}>
                        <div style={{ width: '52px', height: '52px', background: '#f5ede0', border: '1px solid #ede0d0', flexShrink: 0, overflow: 'hidden', borderRadius: '8px' }}>
                          {item.product.image
                ...
                <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid #ede0d0' }}>
                  ...
                  {items.slice(0, 3).map(item => (
                    <div key={item._id} style={{ display: 'flex', gap: '10px', alignItems: 'center', marginBottom: '10px' }}>
                      <div style={{ width: '40px', height: '40px', background: '#f5ede0', border: '1px solid #ede0d0', overflow: 'hidden', flexShrink: 0, borderRadius: '8px' }}>
                        {item.product.image
                          ? <img src={item.product.image} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} />
...
const checkoutStyles = `
  ...
  .co-summary {
    ...
    position: sticky; top: 100px; border-radius: 8px; 
  }
  .delivery-option {
    display: flex; gap: 12px; align-items: center;
    padding: 16px; border: 1.5px solid #ede0d0; border-radius: 8px;
  ...
  .review-card {
    background: rgba(245,237,224,0.5); border: 1px solid #ede0d0; padding: 20px; border-radius: 14px;
  }
  .gold-action-btn {
